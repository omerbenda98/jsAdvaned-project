...
let addFlightPopupSaveBtn = document.getElementById("addFlightPopupsaveBtn");
...
const initPopup = (
  selectedFlightFromHomePage,
  editFlightFromHomePage,
  popupTypeFromHomePage
) => {
  let popupType = popupTypeFromHomePage;

  if (popupType) {
    editPopupSaveBtn.classList.remove("d-none");
    addFlightPopupSaveBtn.classList.add("d-none");
  }
  if (!popupType) {
    editPopupSaveBtn.classList.add("d-none");
    addFlightPopupSaveBtn.classList.remove("d-none");
  }
